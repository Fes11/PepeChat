...
class DialogWindow(QPushButton):
    ...
    def __init__(self, parent=None):
        ...
        self.main_widget.setStyleSheet(f'''QWidget {{background: {MAIN_BOX_COLOR}; color: white; border-radius: 10px; font-size: 13px;}}
                                            ...
                                            QPushButton {{background: {BG_COLOR}; font-weight: bold;}}
